  ...
  if (!prs.length) {
    return (
      <div className="text-center py-20">
        <Trophy size={48} className="mx-auto mb-4" style={{ color: '#475569' }} />
        <h3 className="text-xl font-bold mb-2" style={{ color: '#0f172a' }}>Pas encore de records</h3>
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="rounded-2xl p-5" style={{ background: 'rgba(168,85,247,0.08)', border: '1.5px solid #a855f740' }}>
          ...
          <p className="text-3xl font-black" style={{ color: '#0f172a', fontFamily: 'var(--font-display)' }}>{prs.length}</p>
        </div>
        <div className="rounded-2xl p-5" style={{ background: 'rgba(234,179,8,0.08)', border: '1.5px solid #eab30840' }}>
          ...
          <p className="text-xl font-black" style={{ color: '#0f172a', fontFamily: 'var(--font-display)' }}>
            {(() => {
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {prs
              ...
              .map((eff, i) => (
                <tr key={i} style={{ borderTop: '1px solid rgba(15,23,42,0.10)' }} className="hover:bg-slate-50 transition-colors">
                  <td className="p-4 font-bold" style={{ color: '#0f172a' }}>
                  ...
                  <td className="p-4 text-right font-mono" style={{ color: '#475569' }}>
                  ...
                  <td className="p-4 truncate max-w-xs" style={{ color: '#1f2937' }}>
                    {eff.activityName || '—'}
                  </td>
                  <td className="p-4 text-right" style={{ color: '#475569' }}>
